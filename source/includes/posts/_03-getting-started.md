...
These are the main areas to cover when training beginners, but the list can easily be either expanded or shortened, depending on the training needs. For specific training materials, visit <b>[learnosm.org](learnosm.org)</b> and MapGive’s short tutorials  on <b>[mapgive.state.gov](mapgive.state.gov)</b>.
